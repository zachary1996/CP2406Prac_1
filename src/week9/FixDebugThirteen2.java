...
public class FixDebugThirteen2 {
    public static void main(String[] args) {
        Path fileIn = Paths.get("C:\\users\\zacws\\IdeaProjects\\CP2406_2019_BasicJava\\src\\week9\\DebugData3.txt");
        Path fileOut = Paths.get("C:\\users\\zacws\\IdeaProjects\\CP2406_2019_BasicJava\\src\\week9\\DebugData3new.txt");
        String areaCode = "(312) ";
        String phone;
